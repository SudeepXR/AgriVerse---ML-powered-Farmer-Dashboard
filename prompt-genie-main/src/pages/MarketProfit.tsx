...
const ALL_DISTRICTS = [
  ...
  { value: 'kalburgi', label: 'Kalaburagi District' },
  ...
  { value: 'shimoga', label: 'Shivamogga District' },
  { value: 'tumkur', label: 'Tumakuru District' },
