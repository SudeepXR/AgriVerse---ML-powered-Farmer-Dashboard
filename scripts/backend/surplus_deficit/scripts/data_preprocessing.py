...
if __name__ == "__main__":
    filepath = r"C:\Users\SUDEEP XAVIER ROCHE\VS CODE\EL_3\surplus_deficit-main\surplus_deficit-main\data\crop_data.csv"
    df_processed = preprocess_data(filepath)
    print(df_processed.head())
    df_processed.to_csv(r"C:\Users\SUDEEP XAVIER ROCHE\VS CODE\EL_3\surplus_deficit-main\surplus_deficit-main\data\processed_data.csv", index=False)
